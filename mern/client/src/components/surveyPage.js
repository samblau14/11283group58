...
// This function will handle the submission.
  onSubmit(e) {
    ...
    const newperson = {
		...
		question_2:this.state.question_1,
		question_3:this.state.question_1,
		question_4:this.state.question_1,
		question_5.:this.state.question_1,
		question_6:this.state.question_1,
		question_7:this.state.question_1,
		question_8:this.state.question_1,
		question_9:this.state.question_1,
		question_10:this.state.question_1,
		question_11:this.state.question_1,
		question_12:this.state.question_1,
		question_13:this.state.question_1,
		question_14:this.state.question_1,
		question_15:this.state.question_1,
    };
